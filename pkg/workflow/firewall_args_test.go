...
// TestClaudeEngineAWFEnableApiProxy tests that Claude engine includes --enable-api-proxy in AWF commands
func TestClaudeEngineAWFEnableApiProxy(t *testing.T) {
	t.Run("Claude AWF command includes enable-api-proxy flag", func(t *testing.T) {
		...
		// Check that --enable-api-proxy flag is included for Claude engine
	...
	t.Run("Copilot AWF command does not include enable-api-proxy flag", func(t *testing.T) {
		...
		// Check that --enable-api-proxy flag is NOT included for Copilot engine
		if strings.Contains(stepContent, "--enable-api-proxy") {
