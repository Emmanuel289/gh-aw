...
- **[Go Fan](https://github.com/github/gh-aw/blob/v0.40.0/.github/workflows/go-fan.md?plain=1)** - Daily Go module usage reviewer  
- **[Typist](https://github.com/github/gh-aw/blob/v0.40.0/.github/workflows/typist.md?plain=1)** - Analyzes type usage patterns for improved safety  
...
- **[Repository Quality Improver](https://github.com/github/gh-aw/blob/v0.40.0/.github/workflows/repository-quality-improver.md?plain=1)** - Holistic code quality analysis  
...
The output of Go Fan is a discussion, which is then often "task mined" for actionable tasks using the [TaskOps](https://github.github.com/gh-aw/guides/researchplanassign/).
...
Typist also uses the [TaskOps](https://github.github.com/gh-aw/guides/researchplanassign/) pattern. This means the job of Typist is not to fix code, but to analyze code and recommend possible improvements.
